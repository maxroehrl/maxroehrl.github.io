<template>
  <div class="max-w-3xl mx-auto">
    <div>
      ...
      <p><strong>Vertreten durch: </strong><br />Maximilian Röhrl<br /></p>
      <p>
        <strong>Kontakt:</strong> <br />Telefon: 015203960133<br />E-Mail:
        <a href="mailto:max.roehrl11+website@gmail.com">
          max.roehrl11+website@gmail.com
        </a>
        <br />
      </p>
      <p>
        ...
        Bearbeitung, Verbr/eitung und jede Art der Verwertung außerhalb der
        Grenzen des Urheberrechtes bedürfen der schriftlichen Zustimmung des
        jeweiligen Autors bzw. Erstellers. Downloads und Kopien dieser Seite
        sind nur für den privaten, nicht kommerziellen Gebr/auch gestattet.
