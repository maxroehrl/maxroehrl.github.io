<template>
  <div class="max-w-3xl mx-auto">
    <div class="w-full">
      ...
      <h2 class="text-3xl mt-4">1. Datenschutz auf einen Blick</h2>
      <h3 class="text-2xl mt-2">Allgemeine Hinweise</h3>
      <p>
      ...
      <h3 class="text-2xl mt-2">Datenerfassung auf dieser Website</h3>
      <h4 class="text-1xl">
      ...
      <h4 class="text-1xl">Wofür nutzen wir Ihre Daten?</h4>
      <p>
        Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der
        Website zu gewährleisten. Andere Daten können zur Analyse Ihres
        Nutzerverhaltens verwendet werden.
      </p>
      <h4 class="text-1xl">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
      <p>
      ...
      <h3 class="text-2xl mt-2">Analyse-Tools und Tools von Dritt­anbietern</h3>
      <p>
      ...
      <h2 class="text-3xl mt-4">2. Hosting</h2>
      <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
      <h3 class="text-2xl mt-2">Externes Hosting</h3>
      <p>
      ...
      <h4 class="text-1xl">Auftragsverarbeitung</h4>
      <p>
      ...
      <h3 class="text-2xl mt-2">Datenschutz</h3>
      <p>
      ...
      <h3 class="text-2xl mt-2">Hinweis zur verantwortlichen Stelle</h3>
      <p>
      ...
      <p>
        ...
        E-Mail: max.roehrl11+website@gmail.com
      </p>
      <p>
      ...
      <h3 class="text-2xl mt-2">Speicherdauer</h3>
      <p>
      ...
      <h3 class="text-2xl mt-2">Recht auf Daten­übertrag­barkeit</h3>
      <p>
      ...
      <h3 class="text-2xl mt-2">Auskunft, Löschung und Berichtigung</h3>
      <p>
      ...
      <h3 class="text-2xl mt-2">Recht auf Einschränkung der Verarbeitung</h3>
      <p>
      ...
      <h3 class="text-2xl mt-2">SSL- bzw. TLS-Verschlüsselung</h3>
      <p>
      ...
      <h2 class="text-3xl mt-4">4. Datenerfassung auf dieser Website</h2>
      <h3 class="text-2xl mt-2">Cookies</h3>
      <p>
      ...
      <h3 class="text-2xl mt-2">Anfrage per E-Mail, Telefon oder Telefax</h3>
      <p>
      ...
      <h2 class="text-3xl mt-4">5. Analyse-Tools und Werbung</h2>
      <h3 class="text-2xl mt-2">Matomo</h3>
      <p>Diese Website benutzt den Open Source Webanalysedienst Matomo.</p>
      <p>
        Mit Hilfe von Matomo sind wir in der Lage Daten über die Nutzung unserer
        Website durch die Websitebesucher zu erfassen und zu analysieren.
        Hierdurch können wir u.&nbsp;a. herausfinden, wann welche Seitenaufrufe
        ...
        Browser und Betriebssysteme) und können messen, ob unsere
        Websitebesucher bestimmte Aktionen durchführen (z.&nbsp;B. Klicks, Käufe
        u. Ä.).
      </p>
      <p>
        ...
        wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6
      ...
      <h4 class="text-1xl">IP-Anonymisierung</h4>
      <p>
        Bei der Analyse mit Matomo setzen wir IP-Anonymisierung ein. Hierbei
        wird Ihre IP-Adresse vor der Analyse gekürzt, sodass Sie Ihnen nicht
        mehr eindeutig zuordenbar ist.
      </p>
      <h4 class="text-1xl">Cookies</h4>
      <p>Das setzten und nutzen von Tracking-Cookies wurde deaktiviert.</p>
      <h4 class="text-1xl">Hosting</h4>
      <p>Wir hosten Matomo bei folgendem Anbieter:</p>
      <h3 class="text-2xl mt-2">Externes Hosting</h3>
      <p>
        Matomo wird extern gehostet. Die Daten werden auf den Servern des
        Hosters / der Hoster gespeichert. Hierbei kann es sich v.&nbsp;a. um
        IP-Adressen, Kontaktanfragen, Meta- und Kommunikationsdaten,
        Kontaktdaten, Websitezugriffe und sonstige Daten, die über eine Website
