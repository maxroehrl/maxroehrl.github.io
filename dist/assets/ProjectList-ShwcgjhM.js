import{A as e,B as t,b as n,d as r,e as i,f as a,h as o,i as s,l as c,m as l,n as u,o as d,p as f,q as p,r as m,s as h,u as g,w as _,x as v,y}from"./index-D-VKjiwt.js";const b={};function x(e){return e.getIsPending!==void 0}function ee(e){if(x(e))return e;let t=!0,n=e.then(e=>(t=!1,e),e=>{throw t=!1,e});return n.getIsPending=function(){return t},n}function S(e){let t={},n=e.attributes;if(!n)return t;for(let e=n.length-1;e>=0;e--)t[n[e].name]=n[e].value;return t}function C(e){return Object.keys(e).reduce((t,n)=>(e[n]!==!1&&e[n]!==null&&e[n]!==void 0&&(t[n]=e[n]),t),{})}function w(e,t){let{class:n,style:r,...i}=S(e),{class:a,style:o,...s}=C(t);return{class:[n,a],style:[r,o],...i,...s}}const T=c({inheritAttrs:!1,__name:`InlineSvg`,props:{src:{},title:{default:void 0},transformSource:{type:Function,default:e=>e},keepDuringLoading:{type:Boolean,default:!0},uniqueIds:{type:[Boolean,String],default:!1},uniqueIdsBase:{default:``}},emits:[`loaded`,`unloaded`,`error`],setup(e,{expose:t,emit:n}){let r=e,a=n,s=i(),c=y(),d=y(),f=y(),p=Math.random().toString(36).substring(2);t({svgElSource:c,request:f}),_(()=>r.src,e=>{g(e)}),g(r.src);function m(e){if(e=e.cloneNode(!0),r.uniqueIds){let t=typeof r.uniqueIds==`string`?r.uniqueIds:p;e=C(e,t,r.uniqueIdsBase)}return e=r.transformSource(e),r.title&&S(e,r.title),e.innerHTML}function g(e){b[e]||(b[e]=v(e)),c.value&&b[e].getIsPending()&&!r.keepDuringLoading&&(c.value=null,a(`unloaded`)),b[e].then(e=>{c.value=e,o(()=>{a(`loaded`,d.value)})}).catch(t=>{c.value&&(c.value=void 0,a(`unloaded`)),delete b[e],a(`error`,t)})}function v(e){return ee(new Promise((t,n)=>{let r=new XMLHttpRequest;r.open(`GET`,e,!0),f.value=r,r.onload=()=>{if(r.status>=200&&r.status<400)try{let e=new DOMParser().parseFromString(r.responseText,`text/xml`).getElementsByTagName(`svg`)[0];e?t(e):n(Error(`Loaded file is not valid SVG"`))}catch(e){n(e)}else n(Error(`Error loading SVG`))},r.onerror=n,r.send()}))}let x=()=>c.value?u(`svg`,{...w(c.value,s),innerHTML:m(c.value),ref:d}):null;function S(e,t){let n=e.getElementsByTagName(`title`);if(n.length)n[0].textContent=t;else{let n=document.createElementNS(`http://www.w3.org/2000/svg`,`title`);n.textContent=t,e.insertBefore(n,e.firstChild)}}function C(e,t,n=``){let r=[`id`,`href`,`xlink:href`,`xlink:role`,`xlink:arcrole`],i=[`href`,`xlink:href`],a=(e,t)=>i.includes(e)&&(t?!t.includes(`#`):!1);return[...e.children].forEach(e=>{var i;if((i=e.attributes)!=null&&i.length){let i=Object.values(e.attributes).map(e=>{let r=/url\((.*?)\)/.exec(e.value);return r!=null&&r[1]&&(e.value=e.value.replace(r[0],`url(${n}${r[1]}_${t})`)),e});r.forEach(e=>{let n=i.find(t=>t.name===e);n&&!a(e,n.value)&&(n.value=`${n.value}_${t}`)})}return e.children.length?C(e,t,n):e}),e}return(e,t)=>(l(),h(x))}}),E={class:`top-content`},D=[`innerHTML`],O={key:0,class:`bottom-links`},k=[`src`,`alt`],A={key:1,class:`bottom-links`},j={class:`bottom-group-hor`},M=[`src`,`alt`],N={key:1},P=[`data-fancybox`,`src`,`alt`],F={key:2,class:`bottom-links`},I=[`href`];var L=c({__name:`Project`,props:{project:{type:Object,required:!0}},setup(n){return(i,o)=>{let c=f(`router-link`);return l(),a(`li`,{class:e({"full-width":n.project.full})},[p(`div`,E,[p(`h2`,null,t(n.project.title),1),p(`em`,null,t(n.project.year),1),p(`div`,{innerHTML:n.project.description},null,8,D)]),n.project.screenshots.length===1?(l(),a(`div`,O,[p(`img`,{"data-fancybox":``,src:n.project.screenshots[0].url,alt:n.project.screenshots[0].caption,class:e(n.project.screenshots[0].class)},null,10,k)])):n.project.screenshots.length>1?(l(),a(`div`,A,[(l(!0),a(m,null,s(n.project.screenshots,r=>(l(),a(`div`,{key:r.url,class:`bottom-group-ver`},[p(`div`,j,[r.thumb?(l(),a(`img`,{key:0,src:r.thumb,alt:r.caption,class:`small-icon`},null,8,M)):g(``,!0),r.caption?(l(),a(`h3`,N,t(r.caption),1)):g(``,!0)]),p(`img`,{"data-fancybox":n.project.id,src:r.url,alt:r.caption,class:e(r.class)},null,10,P)]))),128))])):g(``,!0),n.project.links.length?(l(),a(`div`,F,[(l(!0),a(m,null,s(n.project.links,e=>(l(),a(`div`,{key:e.url},[e.url.startsWith(`/`)?(l(),h(c,{key:1,to:e.url,class:`bottom-link`},{default:r(()=>[d(t(e.text),1)]),_:2},1032,[`to`])):(l(),a(`a`,{key:0,href:e.url,class:`bottom-link`,target:`_blank`},[e.img?(l(),h(v(T),{key:0,src:`./assets/${e.img}.svg`,class:`smaller-icon`},null,8,[`src`])):g(``,!0),p(`p`,null,t(e.text),1)],8,I))]))),128))])):g(``,!0)],2)}}}),R=n(L,[[`__scopeId`,`data-v-15f978ec`]]),z=`/assets/transformer_toolkit_screenshot-DK3ysYC3.png`,B=`/assets/soundboard_screenshot-DTNLYRrh.png`,V=`/assets/vibrance_utility-IW1h4buA.png`,H=`/assets/dolphin_updater_screenshot-_N-Daw3r.png`,U=`/assets/abalone-dI8UwrW-.png`,W=`/assets/tcp_chat-rBvC_sCR.png`,G=`/assets/aurora_screenshot-BMqoQyz4.png`,te=`/assets/phi_screenshot-DmhNFz4J.png`,K=`/assets/rho_screenshot-BoG_3jdv.png`,q=`/assets/rho-CfXyBgxV.png`,J=`/assets/phi-CVBUBdjX.png`,Y=`/assets/aurora-BZSSahQs.png`,X=`/assets/lante_light_screenshot-Dxb2Ax-l.png`,Z=`/assets/lante_dark_screenshot-BX1JPsyM.png`,Q=`/assets/lante_chat_screenshot-BbMqybd2.png`,ne=`/assets/lante_history_screenshot-5SLeMZlL.png`,re=`/assets/d3-D1DUamuv.png`,ie=`/assets/simplification-CYCznMQK.jpg`,ae=`/assets/prismatik-eBmlpUTC.png`,oe=`/assets/photobox-D4qtqM2T.jpg`,se=`/assets/vueddit1-DHumijuO.png`,ce=`/assets/vueddit2-CBwY3fBZ.png`,le=`/assets/aurora_cm11-BQozwQLs.jpg`,ue=`/assets/remics_jb-VOoEtQmU.png`,de=`/assets/remics_jb2-DN6Ml12z.png`,fe=`/assets/remics_jb3-DCYjMW1L.png`,pe=`/assets/remics_jb4-aiIF884b.png`,$=`/assets/vueddit2_1-CPtUMxCS.png`,me=`/assets/vueddit2_2-DvAiqXui.png`,he=`/assets/home-CyL790H5.png`,ge=`/assets/calender-B0ajLPNO.png`,_e=`/assets/moodGeneral-Cv3bFhve.png`,ve=`/assets/medsAdd-tYA2Nayh.png`;const ye={id:`projects`};var be=c({__name:`ProjectList`,setup(e){let t=y([{id:1,title:`Vueddit (Reddit App)`,year:`2020 May`,full:!0,description:`<p>A Reddit client for Android built with NativeScript-Vue</p>
                <ul>
